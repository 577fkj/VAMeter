...
static uint8_t __g_font_buf[264]; // 如bin文件存在SPI FLASH可使用此buff
...
static uint8_t *__user_font_getdata(int offset, int size)
{
    ...
    {
        partition_font = esp_partition_find_first(0x50, 0x16, "font_16");
...
// 字模高度：24
// XBF字体,外部bin文件
lv_font_t lv_font_siyuan_chinese_bold_16 = {
